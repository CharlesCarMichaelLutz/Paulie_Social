...
namespace PaulieSocialWebApi.Repositories.TweetRepository
{
    public class TweetRepository : ITweetRepository
    {
        ...
        public TweetRepository(HttpClient httpClient)
        {
            _httpClient = httpClient;
        }

        //Twitter Service Methods
        public async Task<IEnumerable<TweetModel>> GetTweetsByContent(string username)
        {
            List<TweetModel> tweets = new List<TweetModel>();

            var extensionApi = $"tweets/search/recent?query={username}";
        ...
        //Mock Service Tweet list

        //private static List<TweetModel> mockTweets = new List<TweetModel>()
        //{
        //   new TweetModel()
        //   {
        ...
        //public IEnumerable<TweetModel> GetTweetsByContent(string searchTerm)
        //{
        //    List<TweetModel> tweets = new List<TweetModel>();

        //    foreach(TweetModel twitter in mockTweets) 
        //    { 
        ...
        //public IEnumerable<TweetModel> GetTweetsByUsername(string username)
        //{
        //    List<TweetModel> tweets = new List<TweetModel>();
        ...
        //    return tweets;
        //}
        //public TweetModel GetRandomTweet(int id)
        //{
